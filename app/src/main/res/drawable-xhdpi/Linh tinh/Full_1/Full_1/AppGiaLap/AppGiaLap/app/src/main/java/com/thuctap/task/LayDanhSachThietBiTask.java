...
public class LayDanhSachThietBiTask extends AsyncTask<Void, Void, ArrayList<ThietBi>> {
    Activity activity;
    ArrayList<ThietBi> arrThietBi =  new ArrayList<>();
    ThietBiAdapter thietBiAdapter;

    public LayDanhSachThietBiTask(Activity activity, ArrayList<ThietBi> arrThietBi, ThietBiAdapter thietBiAdapter){
